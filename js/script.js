...
------------------------------------------------------*/
    ...
    // main directions
      map = new GMaps({
        el: '#map', lat: 17.469473, lng: 78.426689, zoom: 13, zoomControl : true, 
        zoomControlOpt: { style : 'SMALL', position: 'TOP_LEFT' }, panControl : false, scrollwheel: false
      });
    // add address markers
    map.addMarker({ lat: 17.469473, lng:  78.426689, title: 'Arth design build',
      infoWindow: { content: '<p>Tnr Plaza, 103, Moosapet, Hyderabad, India</p>' } });
